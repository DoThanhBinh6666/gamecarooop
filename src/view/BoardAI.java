...
public final class BoardAI extends javax.swing.JFrame {
    ...
    public BoardAI() {
        initComponents();
        blank = new ImageIcon("src/IMG/blank.png");
            ...
            for (int j = 0; j < Buttons.length; j++) {
                ...
                Buttons[i][j].addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        for (int i = 0; i < Buttons.length; i++) {
                            for (int j = 0; j < Buttons.length; j++) {
                                //them dieu kien de khong danh vao o da danh
                                if(e.getSource() == Buttons[i][j] && Buttons[i][j].getIcon() == null ){
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/X1.png"))); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/O1.png"))); // NOI18N
